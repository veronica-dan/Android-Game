...
public class LoadingScreen extends MyScreen {
    ...
    public void show() {
        ...
        logo2 = new Image(new Texture(Gdx.files.internal("logo2.png")));
       ...
       // stage.addActor(new Image(new Texture(Gdx.files.internal("background.png"))));
    ...
    public void resize(int width, int height) {
       ...
       // stage.setViewport(width , height, false);
        ...
        logo2.setX((width - logo.getWidth()) / 2);
        logo2.setY((height - logo.getHeight()) / 2 + 100);
